...
➸ Comando : *${prefix}sticker* ou *${prefix}stiker* ou *${prefix}s*
➸ útil em : converter imagem/gif/vídeo em figurinha
➸ uso : responder imagem/gif/video ou enviar imagem/gif/video com legenda\n
➸ Comando : *${prefix}sticker nobg* ou *${prefix}stiker nobg*
➸ útil em : converter imagem em figurinha removendo o fundo
➸ uso : responder imagem ou enviar imagem com legenda/n
➸ Comando : *${prefix}toimg*
➸ útil em : converter figurinha em imagem
➸ uso : sei la deve servir pra algo\n
➸ Comando : *${prefix}tsticker* ou *${prefix}tstiker*
➸ útil em : converter texto em figurinha
...
➸ útil em : alterar o prefix do bot
...
➸ útil em : tornar o administrador em um membro comum
➸ uso : *${prefix}demote e o @da pessoa*\n
➸ Nota : Você precisa ser admin e o bot também

       • ────── ✾ ────── •
       *MENU DO PM PACOKINHA*【✔】
       • ────── ✾ ────── •              
